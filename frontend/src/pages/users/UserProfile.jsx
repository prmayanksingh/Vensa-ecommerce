...
const UserProfile = () => {
  ...
  return (
    <section className="text-[3.7vw] bg-[#F5F6F8] sm:text-[2.6vw] md:text-[2vw] lg:text-[1.4vw] xl:text-[16px]">
      <Nav />
      <div className="w-full h-[3.2em] flex justify-end pt-[1.2em] px-[1.6em] md:px-[3em] lg:px-[3em]">
        <button
          onClick={logoutHandler}
          className="w-fit flex items-center gap-1 bg-gray-500 text-[1.1em] text-white rounded px-[1em] py-[.2em]"
        >
          <BiLogOutCircle />
          Logout
        </button>
      </div>
      <div className="min-h-[calc(100vh-6.7rem)] p-4 px-[1.6em] md:px-[3em] lg:px-[3em] pt-[1.9em] md:pt-[5em] lg:py-[3em] xl:px-[9em] flex flex-col lg:flex-row lg:items-center gap-[3.5em] md:gap-[4em] xl:gap-[9em]">
        ...
        <div className="lg:w-[45%] xl:w-[40%] bg-white p-[1.7em] md:p-[2.5em] lg:p-9 lg:pt-7 xl:p-11 xl:pt-7 rounded-3xl shadow-2xl">
