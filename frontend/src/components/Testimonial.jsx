  ...
  return (
    <section className="px-[1.5em] sm:px-[7em] md:px-[12em] lg:px-[27vw] xl:px-[33vw] py-[4em] flex flex-col items-center gap-[1.55em] lg:gap-[1.7em] xl:gap-[2em] text-[clamp(10px,3.5vw,16px)] sm:text-[clamp(14px,2.7vw,16px)] md:text-[clamp(14px,2vw,16px)] lg:text-[17px] xl:text-[clamp(14px,1.1vw,18px)]">
        ...
        <div className="flex items-center gap-[3em] lg:gap-[4em]">
          ...
          <div className="w-[10em] lg:w-[12em] h-[10em] lg:h-[12em] rounded-full bg-gray-100">
            <img
              ...
              src={pexels(
                "https://images.pexels.com/photos/20321952/pexels-photo-20321952.jpeg",
                200,
                200,
                2
              )}
      ...
      <h2 className="text-center text-[1.1em] text-gray-500 leading-[1.2em]">
        Vensa.co delivers premium quality fashion and essentials with a perfect
        mix of style and comfort. From trendy outfits to everyday must-haves,
        everything feels reliable and affordable. Truly my go-to destination for
        shopping!
      </h2>
