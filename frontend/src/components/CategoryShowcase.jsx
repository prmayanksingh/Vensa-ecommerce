...
const CategoryShowcase = () => {
  return (
    <section className="bg-gray-100 py-[.5em] flex flex-nowrap gap-[.5em] overflow-x-auto lg:overflow-x-hidden scroll-smooth text-[clamp(10px,3.8vw,16px)] sm:text-[2.7vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[clamp(14px,1.2vw,24px)]">
