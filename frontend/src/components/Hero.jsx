    ...
    <>
      ...
      <div className="text-white pl-4 pb-8 sm:pl-8 sm:pb-10 lg:pl-14 lg:pb-14 xl:pl-18 xl:pb-15">
        ...
        <div className="flex mt-[1.8em] sm:mt-[2.2em] xl:mt-[2.6em] gap-6">
          <Link to={"/products"} className="px-[1.2em] py-[.4em] bg-white text-black text-[1.1em] font-semibold rounded-xl">Shop Now</Link>
          <button className="text-[1.1em] flex gap-1 items-center">Learn More <IoIosArrowForward className="text-[1.2em]" /> </button>
        </div>
      </div>
      </div>
    </>
